...
package com.android.systemui.custom.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.custom.header.STATUS_BAR_HEADER_UPDATE";
