...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        mCesiumSettingsObserver.observe();
        mCesiumSettingsObserver.update();
    ...
    private CesiumSettingsObserver mCesiumSettingsObserver = new CesiumSettingsObserver(mHandler);
    private class CesiumSettingsObserver extends ContentObserver {
        CesiumSettingsObserver(Handler handler) {
            super(handler);
        }
